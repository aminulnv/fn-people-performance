...
export function HomeGoalsIcon({ className = 'pd-home-banner__icon-svg' }: IconProps) {
  return (
    <svg className={className} viewBox="28 42 92 102" fill="none" aria-hidden>
      <path
...
/** Sent-back mark — undo arrow (Figma reference, same crop pattern as goals). */
export function HomeSentBackIcon({ className = 'pd-home-banner__icon-svg' }: IconProps) {
  return (
    <svg className={className} viewBox="55.5 45.5 78 78" fill="none" aria-hidden>
