...
export function CalibrationEditPage({
  ...
  return (
    <EditPageShell
      ...
      description="Who calibrates first, then dates, recommendations, and the grade mix."
      onBack={onClose}
      onSave={save}
      saving={saving}
      error={error}
    ...
    >
      <div className="pd-settings-stack">
        <section className="pd-settings-stack__block">
          ...
          />
          <div
            className="pd-reviews-choice-picker pd-reviews-choice-picker--tiles pd-settings-stack__choices"
            role="listbox"
        ...
        <section className="pd-settings-stack__block">
          <SectionHeading
            icon={CalendarRange}
            title="When Calibration Happens"
            hint="Turn stages on and set when each calibration window opens and closes."
          />
          <ReviewStageList
            cycle={cycle}
            groupId={group.id}
        ...
        <section className="pd-settings-stack__block">
          <SectionHeading
            ...
            hint={CALIBRATION_SECTION_HINTS.seniorLeadership}
          />
          <GroupMembersEditor
